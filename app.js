...
function mostrarProductosModal() {
    let contenido = `
        <label for="nombreProducto" class="block text-lg font-bold mb-2">Nombre del Producto:</label>
        <input id="nombreProducto" type="text" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese nombre del producto" />
        <button class="bg-green-500 text-white px-4 py-2 rounded mt-4" onclick="agregarProducto()">Agregar Producto</button>
        <button class="bg-red-500 text-white px-4 py-2 rounded mt-4 ml-2" onclick="retirarProducto()">Retirar Producto</button>
        <h3 class="text-xl font-bold mt-4">Productos Disponibles:</h3>
        <ul id="lista-productos-disponibles" class="list-disc list-inside"></ul>
        <h3 class="text-xl font-bold mt-4">Productos Retirados:</h3>
        <ul id="lista-productos-retirados" class="list-disc list-inside"></ul>
    `;
...
function mostrarParesImparesModal() {
    let contenido = `
        <label for="cantidad" class="block text-lg font-bold mb-2">Cantidad de números aleatorios:</label>
        <input id="cantidad" type="number" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese un número" />
        <button class="bg-green-500 text-white px-4 py-2 rounded mt-4" onclick="generarNumeros()">Generar</button>
    `;
...
function mostrarAprobadosModal() {
    let contenido = `
        <label for="nombre" class="block text-lg font-bold mb-2">Nombre del estudiante:</label>
        <input id="nombre" type="text" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese nombre" />
        <label for="calificacion" class="block text-lg font-bold mb-2 mt-4">Calificación:</label>
        <input id="calificacion" type="number" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese calificación (0-10)" />
        <button class="bg-green-500 text-white px-4 py-2 rounded mt-4" onclick="agregarEstudiante()">Agregar Estudiante</button>
        <h3 class="text-xl font-bold mt-4">Estudiantes Aprobados:</h3>
        <ul id="lista-aprobados" class="list-disc list-inside"></ul>
        <h3 class="text-xl font-bold mt-4">Estudiantes Reprobados:</h3>
        <ul id="lista-reprobados" class="list-disc list-inside"></ul>
    `;
...
function mostrarEliminarProductosModal() {
    let contenido = `
        <label for="producto" class="block text-lg font-bold mb-2">Nombre del Producto:</label>
        <input id="producto" type="text" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese nombre del producto" />
        <button class="bg-green-500 text-white px-4 py-2 rounded mt-4" onclick="agregarProductoLista()">Agregar Producto</button>
        <button class="bg-red-500 text-white px-4 py-2 rounded mt-4 ml-2" onclick="eliminarProducto()">Eliminar Producto</button>
        <button class="bg-blue-500 text-white px-4 py-2 rounded mt-4 ml-2" onclick="ordenarProductos()">Ordenar Productos</button>
        <h3 class="text-xl font-bold mt-4">Lista de Productos:</h3>
        <ul id="lista-todos-productos" class="list-disc list-inside"></ul>
    `;
...
function mostrarPalabrasModal() {
    let contenido = `
        <label for="palabra" class="block text-lg font-bold mb-2">Palabra:</label>
        <input id="palabra" type="text" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese una palabra" />
        <button class="bg-green-500 text-white px-4 py-2 rounded mt-4" onclick="agregarPalabra()">Agregar Palabra</button>
        <label for="letra" class="block text-lg font-bold mb-2 mt-4">Filtrar por Letra:</label>
        <input id="letra" type="text" maxlength="1" class="bg-gray-200 text-black px-3 py-2 rounded w-full" placeholder="Ingrese una letra" />
        <button class="bg-blue-500 text-white px-4 py-2 rounded mt-4" onclick="filtrarPorLetra()">Filtrar</button>
        <h3 class="text-xl font-bold mt-4">Palabras Filtradas:</h3>
        <ul id="lista-palabras" class="list-disc list-inside"></ul>
    `;
